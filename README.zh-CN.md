...
- **📦 自包含** —— 算法 vendored + MediaPipe 模型 (5.5 MB) 已入库,clone 即跑,不用为了模型去下 PyPI
...
| [03 · CLI 用法](docs/zh/guide/03-cli-usage.md) | 所有参数、输出 schema、退出码 |
| [04 · REST API](docs/zh/guide/04-rest-api.md) | 端点、payload、WebSocket 事件类型、Range 流 |
| [05 · Electron GUI](docs/zh/guide/05-electron-gui.md) | sidecar 生命周期、dev 工作流、UI 布局 |
| [06 · 算法原理](docs/zh/guide/06-algorithm.md) | v2.1 切分管线是怎么工作的 |
| [07 · 故障排查](docs/zh/guide/07-troubleshooting.md) | 常见坑与解法 |

英文文档:[docs/index.md](docs/index.md)。
