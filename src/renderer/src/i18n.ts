...
const en: Record<string, string> = {
  ...
  'help.params.col.name': 'Name',
  'help.params.col.meaning': 'Meaning',
  'help.params.col.advice': 'Advice',
  'help.params.v_swing.name': 'v_swing',
  'help.params.v_swing.meaning': 'Cut threshold (wrist speed)',
  'help.params.v_swing.advice': 'Higher = looser; lower = more fragments',
  'help.params.gap_merge.name': 'gap_merge',
  'help.params.gap_merge.meaning': 'Merge gap (s) between adjacent swings',
  'help.params.gap_merge.advice': 'Two segments < this apart merge',
  'help.params.max_bridge.name': 'max_bridge',
  'help.params.max_bridge.meaning': 'Bridge upper bound (s)',
  'help.params.max_bridge.advice': 'A break longer than this starts a new segment',
  'help.params.min_peak.name': 'min_peak',
  'help.params.min_peak.meaning': 'Min peak height',
  'help.params.min_peak.advice': 'Peaks below this are not counted as swings',
  'help.params.smooth_alpha.name': 'smooth_alpha',
  'help.params.smooth_alpha.meaning': 'EMA smoothing',
  'help.params.smooth_alpha.advice': 'Higher = tighter follow; lower = more lag',
  'help.params.max_lost_frames.name': 'max_lost_frames',
  'help.params.max_lost_frames.meaning': 'Lost-frame tolerance',
  'help.params.max_lost_frames.advice': 'Bridges wrist losses ≤ this many frames',
  'help.params.min_dur_max_dur.name': 'min_dur / max_dur',
  'help.params.min_dur_max_dur.meaning': 'Segment duration bounds',
  'help.params.min_dur_max_dur.advice': 'Out-of-range segments are dropped / merged',
  'help.params.buf_before_buf_after.name': 'buf_before / buf_after',
  'help.params.buf_before_buf_after.meaning': 'Pre/post buffer (s)',
  'help.params.buf_before_buf_after.advice': 'Clip start/end extend by this much',
  'help.params.skip.name': 'skip',
  'help.params.skip.meaning': 'Sampling step',
  'help.params.skip.advice': 'Run pose detection every N frames',
  'help.params.max_frames.name': 'max_frames',
  'help.params.max_frames.meaning': 'Max frames',
  'help.params.max_frames.advice': '0 = all; >0 = only first N',
  'help.params.save_clips.name': 'save_clips',
  'help.params.save_clips.meaning': 'Save per-segment clip mp4',
  'help.params.save_clips.advice': 'Required for the clips bar',
  'help.params.viz_video.name': 'viz_video',
  'help.params.viz_video.meaning': 'Render whole viz.mp4',
  'help.params.viz_video.advice': 'Required for «Play viz.mp4»',
  'help.params.clip_bbox.name': 'clip_bbox',
  'help.params.clip_bbox.meaning': 'Overlay RTMDet bbox on clips',
  'help.params.clip_bbox.advice': 'Needs save_clips too',
  'help.params.clip_skel.name': 'clip_skel',
  'help.params.clip_skel.meaning': 'Overlay skeleton on clips',
  'help.params.clip_skel.advice': 'Needs save_clips too',
  'help.params.skel_backend.name': 'skel_backend',
  'help.params.skel_backend.meaning': 'Skeleton backend',
  'help.params.skel_backend.advice': 'rtmpose (fast / COCO-13) or mediapipe (precise / 33 pts)',
  ...
  'help.item.menu.about': '<b>Help → About AceCrush-Swing-Analysis</b>: name + version info.',
  ...
  'params.tsInertHint': 'Inert in ts mode — used by the Python sidecar pipeline only',
  'status.tsClipSkipLarge': 'Video too large for in-memory clip cutting (>1.5 GB) — clips skipped; segments & viz unaffected',
  'status.tsVizWebm': 'viz encoded as WebM (mp4 recorder unavailable in this environment)',
  ...
  'menu.about': 'About AceCrush-Swing-Analysis',
...
const zh: Record<string, string> = {
  ...
  'help.params.col.name': '名称',
  'help.params.col.meaning': '含义',
  'help.params.col.advice': '建议',
  'help.params.v_swing.name': 'v_swing',
  'help.params.v_swing.meaning': '切分阈值(手腕速度)',
  'help.params.v_swing.advice': '越高越宽松;越低切得越碎',
  'help.params.gap_merge.name': 'gap_merge',
  'help.params.gap_merge.meaning': '相邻段合并间隔(s)',
  'help.params.gap_merge.advice': '间隔小于此值的相邻段会被合并',
  'help.params.max_bridge.name': 'max_bridge',
  'help.params.max_bridge.meaning': '桥接上限(s)',
  'help.params.max_bridge.advice': '间隔超过此值就强制开新段',
  'help.params.min_peak.name': 'min_peak',
  'help.params.min_peak.meaning': '最低峰值高度',
  'help.params.min_peak.advice': '低于此值的峰不计入挥拍',
  'help.params.smooth_alpha.name': 'smooth_alpha',
  'help.params.smooth_alpha.meaning': 'EMA 平滑系数',
  'help.params.smooth_alpha.advice': '越高跟踪越紧;越低越延迟',
  'help.params.max_lost_frames.name': 'max_lost_frames',
  'help.params.max_lost_frames.meaning': '漏帧容忍帧数',
  'help.params.max_lost_frames.advice': '≤ 此帧数的手腕缺失会被桥接',
  'help.params.min_dur_max_dur.name': 'min_dur / max_dur',
  'help.params.min_dur_max_dur.meaning': '段落时长范围',
  'help.params.min_dur_max_dur.advice': '超出范围的段会被丢弃或合并',
  'help.params.buf_before_buf_after.name': 'buf_before / buf_after',
  'help.params.buf_before_buf_after.meaning': 'clip 前后缓冲(s)',
  'help.params.buf_before_buf_after.advice': 'clip 起止向外扩展该时长',
  'help.params.skip.name': 'skip',
  'help.params.skip.meaning': '采样步长',
  'help.params.skip.advice': '每 N 帧跑一次姿态检测',
  'help.params.max_frames.name': 'max_frames',
  'help.params.max_frames.meaning': '最大处理帧数',
  'help.params.max_frames.advice': '0 表示全部;>0 只处理前 N 帧',
  'help.params.save_clips.name': 'save_clips',
  'help.params.save_clips.meaning': '切出每段 clip mp4',
  'help.params.save_clips.advice': '勾上才能在底部 Clips 区看',
  'help.params.viz_video.name': 'viz_video',
  'help.params.viz_video.meaning': '生成整段 viz.mp4',
  'help.params.viz_video.advice': '勾上才能点「▶ viz.mp4」按钮',
  'help.params.clip_bbox.name': 'clip_bbox',
  'help.params.clip_bbox.meaning': '在 clip 上叠 RTMDet 人框',
  'help.params.clip_bbox.advice': '需同时勾 save_clips',
  'help.params.clip_skel.name': 'clip_skel',
  'help.params.clip_skel.meaning': '在 clip 上叠姿态骨架',
  'help.params.clip_skel.advice': '需同时勾 save_clips',
  'help.params.skel_backend.name': 'skel_backend',
  'help.params.skel_backend.meaning': '骨架后端选择',
  'help.params.skel_backend.advice': 'rtmpose 快 / COCO-13;mediapipe 准 / 33 点',
  ...
  'help.item.menu.about': '<b>Help → About AceCrush-Swing-Analysis</b>：软件名 + 版本信息。',
  ...
  'params.tsInertHint': 'ts 模式暂不生效（仅 python sidecar 管线使用）',
  'status.tsClipSkipLarge': '视频过大（>1.5 GB），已跳过 clip 切出；segments 与 viz 不受影响',
  'status.tsVizWebm': 'viz 以 WebM 编码（当前环境不支持 mp4 录制）',
  ...
  'menu.about': '关于 AceCrush-Swing-Analysis',
